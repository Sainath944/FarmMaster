...
import { output_descriptions } from "../Location/Location.jsx"
...
function focusEmptyFields() {
    ...
    // list of all the input aelements
    const inputElements = [
...
const CROP_ENDPOINT = 'http://192.168.56.1:8000/crop_recommend'
...
function handleClick(navigate) {
    ...
    const data = {
        array: [nitrogenValue, phosphorousValue, potassiumValue,
            tempValue, humidityValue, phValue]
    }
    ...
    fetch(CROP_ENDPOINT, {
        ...
        .then(data => {
            ...
            navigate("/location_result", { state: { predicted_crop: data } })
    ...
    return (
        <>
            ...
            <div className="crop-container">
                <TextField id="nitrogen-crop-input" label="States" variant="outlined" color="success" type="number" />
                <TextField id="temp-crop-input" label="Rainfall" variant="outlined" color="success" type="number" inputProps={{ min: 5, max: 50 }} />
                <TextField id="phosphorous-crop-input" label="Ground Water" variant="outlined" color="success" type="number" />
                <TextField id="humidity-crop-input" label="Temperature" variant="outlined" color="success" type="number" />
                <TextField id="potassium-crop-input" label="Soil type" variant="outlined" color="success" type="number" />
                <TextField id="ph-crop-input" label="Season" variant="outlined" color="success" type="number" />
