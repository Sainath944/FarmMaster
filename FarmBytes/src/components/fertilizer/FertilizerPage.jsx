...
const FERTILIZER_ENDPOINT = 'http://192.168.56.1:8000/fertilizer_recommend' 
// here we need to give our ip address plus local host port number
// as you can see my ip is 192.168.56.1 and my local host port is 8000
